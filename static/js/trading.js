...
function getPlayers(game_id) {
    ...
    console.log("../../api/game/" + game_id.toString() + "/players")
    req.open("GET", "../../api/game/" + game_id.toString() + "/players", true);
    req.send();
}
...
function sendTurn(game_id, data) {
    ...
    console.log(data)
    req.open("POST", "/game/" + game_id.toString() + "/trade", true);
